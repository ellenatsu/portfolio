...
const experienceData = [
  {
    ...
    company: "FundMyWish (Startup)",
    dec: "Led the end-to-end development of a cashback-based gift registry platform for weddings, baby showers, and special events. As the sole developer, I was responsible for product UX design, full-stack implementation, SEO optimization, and payment integration using Stripe and PayPal. Built responsive React frontends, secure Node.js APIs, and PostgreSQL data models. Collaborated directly with the founder and branding advisors to iterate on features and adapt to shifting business goals. Project paused due to loss of funding.",
    startYear: "Oct 2024",
    endYear: "Mar 2025",
  },  
  {
